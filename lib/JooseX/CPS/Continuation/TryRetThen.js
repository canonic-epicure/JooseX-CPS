Class('JooseX.CPS.Continuation.TryRetThen', {
    ...
    use : [ 'JooseX.CPS.Exception.LeaveScope' ],
        ...
        start : function () {
            ...
            setTimeout(function() {
                ...
                try {
                    ...
                    if (e instanceof JooseX.CPS.Exception.LeaveScope) 
                        leavingScope = true
                    else {
                        cont.scopeLeft = true
                        cont.THROW(e)
...
//                        me.handleFinally()
        ...
        handleThrow : function (source, values) {
            if (this.catchFunc) {
                ...
                try {
                    this.catchFunc.apply(this.catchScope, values)
                    
                    this.unnest(source, values)
        ...
        THROW : function (exception) {
            if (this.parent && !this.isNext()) {
                ...
                if (!this.scopeLeft) throw new JooseX.CPS.Exception.LeaveScope
            } else {
