    ...
    methods : {
        ...
        NEXT : function (nextFunc, nextScope, nextArgs) {
            ...
            if (typeof nextFunc == 'function') {
                ...
                if (thenFuns instanceof JooseX.CPS.Continuation) {
                    var next = nextFunc
                    next.setParent(this)
                } else
        ...
        start : function () {
            ...
            setTimeout(function() {
                ...
                try {
                    if (current.func.apply(scope, current.args || results) !== undefined) throw "Value returned from continued function (use CONTINUE() instead)" 
                } catch (e) {
